...
Article.views = ["content", "figures", "footnotes", "supplements", "extrafeatures", "citations", "definitions", "info"];

// Register node types
// --------

Article.nodeTypes = require('lens/article/nodes');

Article.ViewFactory = require('lens/article/view_factory');
...
Article.ResourceView = require('lens/article/resource_view');
